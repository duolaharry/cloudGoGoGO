...
if __name__ == "__main__":
    ...
    def outputpeopleCounts(time, rdd):
        ...
        if len(taken) > 0:
            ...
            item = "allpeople " + "people " + str(record[1]) + " " + str(time)
            data.append(item)
    ...
    def outputpopuCounts(time, rdd):
        ...
        if len(taken) > 0:
            ...
            item = "allpopu " + "popu " + str(record[1]) + " " + str(time)
            data.append(item)
    ...
    def calculateForPeopleChange(time, rdd):
        ...
        for record in calculateChangePeopleDateList:
            item = "peoplechange " + str(record[0]) + " " + str(record[1]) + " " + str(time)
            data.append(item)
    ...
    def calculateForPopuChange(time, rdd):
        ...
        for record in calculateChangePopuDateList:
            item = "popuchange " + str(record[0]) + " " + str(record[1]) + " " + str(time)
            data.append(item)
